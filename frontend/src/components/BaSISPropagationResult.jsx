...
export default function BaSISPropagationResult({ selectedUser, onClose, model }) {
  ...
  const eventPrefix = model === 'holme-kim' ? 'hkSISPropagation' : 'baSISPropagation';
...
BaSISPropagationResult.propTypes = {
