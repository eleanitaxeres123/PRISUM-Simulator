...
function BarabasiSIRGraph3D({ data, nodesWithCentrality, onNodeInfo, highlightedLinks = [], highlightId, onResetView, beta, gamma, selectedUser}) {
  const fgRef = useRef();
  ...
  useEffect(() => {
    ...
    window.dispatchEvent(new CustomEvent('baSIRPropagationStart'));
    ...
    const finalTimeout = setTimeout(() => {
      ...
      const finishedEvent = new CustomEvent('baSIRPropagationFinished');
