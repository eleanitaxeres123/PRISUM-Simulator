...
import './BarabasiSISInput.css';
import './PolicySeedingInput.css';

export default function BarabasiSISInput({ nodes, onStartPropagation }) {
  ...
  return (
    <div className="sis-navbar">
      ...
      <div className="sis-input-container">
          <label htmlFor="propagation-name" className="sis-label">Nombre de Propagación</label>
          <input
            id="propagation-name"
            type="text"
            ...
            className="sis-input"
            placeholder="Ej. Propagación SIS Test"
            maxLength="100"
          />
        </div>
