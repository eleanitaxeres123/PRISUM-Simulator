...
export default function HkSISPropagationResult({ selectedUser, onClose }) {
  ...
  useEffect(() => {
    ...
    window.addEventListener('hkSISPropagationStart', handlePropagationStart);
    window.addEventListener('hkSISPropagationUpdate', handlePropagationUpdate);
    window.addEventListener('hkSISPropagationFinished', handlePropagationFinished);

    return () => {
      window.removeEventListener('hkSISPropagationStart', handlePropagationStart);
      window.removeEventListener('hkSISPropagationUpdate', handlePropagationUpdate);
      window.removeEventListener('hkSISPropagationFinished', handlePropagationFinished);
    };
  }, []);
...
HkSISPropagationResult.propTypes = {
