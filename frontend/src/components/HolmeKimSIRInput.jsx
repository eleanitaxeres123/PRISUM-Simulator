  ...
  return (
    <div className="sir-navbar">
      <div className="sir-navbar-controls">
        ...
        <div className="sir-input-container">
          <label htmlFor="hk-sir-propagation-name" className="sir-label">Nombre de Propagación</label>
          <input
            id="hk-sir-propagation-name"
            type="text"
            value={propagationName}
            onChange={(e) => setPropagationName(e.target.value)}
            className="sir-input"
            placeholder="Ej. Propagación SIR Holme-Kim"
            maxLength="100"
          />
        </div>
