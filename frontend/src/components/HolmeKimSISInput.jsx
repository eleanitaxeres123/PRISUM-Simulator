...
import './HolmeKimSISInput.css';
import './PolicySeedingInput.css';

export default function HolmeKimSISInput({ nodes, onStartPropagation }) {
    ...
    <div className="sis-navbar">
      <div className="sis-navbar-controls">
        <div className="sis-input-container">
          <label htmlFor="hk-sis-beta" className="sis-label">Tasa de Infección (β)</label>
          <input
            id="hk-sis-beta"
            type="number"
            step="0.01"
        ...
        <div className="sis-input-container">
          <label htmlFor="hk-sis-gamma" className="sis-label">Tasa de Recuperación (γ)</label>
          <input
            id="hk-sis-gamma"
            type="number"
            step="0.01"
        ...
        <div className="sis-input-container">
          <label htmlFor="hk-sis-propagation-name" className="sis-label">Nombre de Propagación</label>
          <input
            id="hk-sis-propagation-name"
            type="text"
            value={propagationName}
            onChange={(e) => setPropagationName(e.target.value)}
            className="sis-input"
            placeholder="Ej. Propagación SIS Holme-Kim"
            maxLength="100"
          />
        </div>
